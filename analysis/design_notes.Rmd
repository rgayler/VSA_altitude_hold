...
This notebook records the thinking behind implementing altitude hold in
...
This reduces the probability that we will hit an obstacle requiring us
to completely reconceptualise how altitude hold is done. On the other
hand, it means that we will parallel the classical altitude hold
computation, so we may miss seeing some (hypothetical) VSA-centric
solution that has no classical analogue.

# Data Flow Diagram

-   The data floww diagram represents the desired calculation for
    altitude hold.
